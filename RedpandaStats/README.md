...
This python script uses [confluent_kafka](https://docs.confluent.io/).  To run this python script you will need to make sure you have this installed on your machine. To install run:

```bash
pip install confluent_kafka
```

Now to run the python script execute:
