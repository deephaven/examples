...
These partitioned parquet files are provided by [Clark Fitzgerald](https://anson.ucdavis.edu/~clarkf/) and show the ability to read such structured files in the Deephaven Community Edition.

The data represent aggregate traffic flow collected every 30 second from raw sensors on the three lanes of traffic from January to October 2016 for a location of the I80 corridor near Davis, CA.
...
Occupancy is a measure of how much of the roadway is covered by vehicles.  A related quantity is the freeway density, measured in vehicles per mile.
In this location there are only three lanes so only three sensors of information are provided. Lanes 5-8 are present in the _meta_common to facilitate import other locations into the dataset.
...
## Fields
  ...
  - **flow1 (int):**  The number of vehicles observed in lane 1 for sample period.
  ...
  - **flow2 (int):**  The number of vehicles observed in lane 2 for sample period.
  ...
  - **flow3 (int):**  The number of vehicles observed in lane 3 for sample period.
  ...
  - **flow4 (int):**  Null for this location. The number of vehicles observed in lane 4 for sample period.
  ...
  - **flow5 (int):**  Null for this location. The number of vehicles observed in lane 5 for sample period.
  ...
  - **flow6 (int):**  Null for this location. The number of vehicles observed in lane 6 for sample period.
  ...
  - **flow7 (int):**  Null for this location. The number of vehicles observed in lane 7 for sample period.
  ...
  - **flow8 (int):**  Null for this location. The number of vehicles observed in lane 8 for sample period.
